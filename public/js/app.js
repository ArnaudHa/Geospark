...
__webpack_require__(/*! ./testclo */ "./resources/js/testclo.js"); //require('./bootstrapbundlemin');
...
searchInput.addEventListener('input', function (e) {
  ...
  fetch('https://nominatim.openstreetmap.org/search?format=json&polygon=1&addressdetails=1&q=' + query).then(function (result) {
    return result.json();
...
function setResultList(parsedResult) {
  ...
  var _iterator = _createForOfIteratorHelper(currentMarkers),
      _step;
  ...
  var _iterator2 = _createForOfIteratorHelper(parsedResult),
      _step2;
